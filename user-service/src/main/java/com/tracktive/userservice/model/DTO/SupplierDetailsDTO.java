...
/**
* Description: Supplier Details DTO
* @author William Theo
* @date 23/4/2025
*/
public class SupplierDetailsDTO {
    ...
    public SupplierDetailsDTO(String ssmRegistrationNumber, String businessName, String businessAddress, String bankAccount, String bankName) {
