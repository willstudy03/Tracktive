...
import com.tracktive.userservice.util.annotation.ValidUserCreation;
...
public class UserCreationRequestDTO {
    ...
    public UserCreationRequestDTO(String name, String email, String phoneNumber, UserRole userRole, RetailerDetailsDTO retailerDetailsDTO, SupplierDetailsDTO supplierDetailsDTO) {
        this.name = name;
        this.email = email;
